...
import { 
  Calculator, Building2, Hotel, ShoppingBag, Factory, Library,
  Binary, Database, Cloud, Shield, Smartphone, Bot,
  ChevronRight, Cpu, Phone, Mail, MapPin, 
  FileSpreadsheet, Store, Briefcase, Truck, Hospital,
  GitBranch, Users, Settings, BarChart, School,
  Coffee, Dumbbell, Code
} from 'lucide-react';
        ...
        <nav className="container px-6 py-4 mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden space-x-8 md:flex">
              ...
              <a href="#soluciones" className="transition-colors hover:text-blue-400">Soluciones</a>
        ...
        <div className="container relative z-10 px-6 mx-auto">
          <div className="text-center">
            ...
            <p className="max-w-3xl mx-auto mb-8 text-xl text-gray-300">
              Expertos en crear soluciones tecnológicas a medida para todo tipo de empresas.
              Sistemas web y escritorio con tecnología de última generación.
            </p>
        ...
        <div className="container relative px-6 mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="p-8 transition-all bg-gray-800 bg-opacity-50 border border-gray-700 rounded-2xl hover:bg-opacity-70 hover:border-blue-500 group">
              ...
              <h3 className="mb-4 text-xl font-semibold text-center text-blue-400">Sistema Contable</h3>
            ...
            <div className="p-8 transition-all bg-gray-800 bg-opacity-50 border border-gray-700 rounded-2xl hover:bg-opacity-70 hover:border-blue-500 group">
              ...
              <h3 className="mb-4 text-xl font-semibold text-center text-blue-400">Sistema Hotelero</h3>
              <ul className="space-y-2 text-gray-400">
            ...
            <div className="p-8 transition-all bg-gray-800 bg-opacity-50 border border-gray-700 rounded-2xl hover:bg-opacity-70 hover:border-blue-500 group">
              ...
              <h3 className="mb-4 text-xl font-semibold text-center text-blue-400">Punto de Venta</h3>
              <ul className="space-y-2 text-gray-400">
            ...
            <div className="p-8 transition-all bg-gray-800 bg-opacity-50 border border-gray-700 rounded-2xl hover:bg-opacity-70 hover:border-blue-500 group">
              ...
              <h3 className="mb-4 text-xl font-semibold text-center text-blue-400">Sistema Restaurante</h3>
              <ul className="space-y-2 text-gray-400">
            ...
            <div className="p-8 transition-all bg-gray-800 bg-opacity-50 border border-gray-700 rounded-2xl hover:bg-opacity-70 hover:border-blue-500 group">
              ...
              <h3 className="mb-4 text-xl font-semibold text-center text-blue-400">Sistema Educativo</h3>
              <ul className="space-y-2 text-gray-400">
            ...
            <div className="p-8 transition-all bg-gray-800 bg-opacity-50 border border-gray-700 rounded-2xl hover:bg-opacity-70 hover:border-blue-500 group">
              ...
              <h3 className="mb-4 text-xl font-semibold text-center text-blue-400">Sistema Gimnasio</h3>
              <ul className="space-y-2 text-gray-400">
        ...
        <div className="container px-6 mx-auto">
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="transition-colors hover:text-blue-400">Sistema Contable</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Sistema Hotelero</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Punto de Venta</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Sistemas a Medida</a></li>
              </ul>
            </div>
            <div>
              <h4 className="mb-4 font-semibold text-blue-400">Empresa</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="transition-colors hover:text-blue-400">Sobre Nosotros</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Casos de Éxito</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Blog</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Soporte</a></li>
              </ul>
            </div>
            <div>
              <h4 className="mb-4 font-semibold text-blue-400">Legal</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="transition-colors hover:text-blue-400">Términos y Condiciones</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Política de Privacidad</a></li>
                <li><a href="#" className="transition-colors hover:text-blue-400">Libro de Reclamaciones</a></li>
              </ul>
            </div>
          </div>
